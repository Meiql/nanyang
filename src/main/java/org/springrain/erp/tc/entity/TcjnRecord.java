 ...
 * @see org.springrain.erp.gz.entity.TcjnRecord
 */
@Table(name="z_tcjn_record")
public class TcjnRecord  extends BaseEntity {
	
	private static final long serialVersionUID = 1L;

	//alias
	/*
	public static final String TABLE_ALIAS = "社保公积金缴纳报表";
    ...
    */
	 ...
	 * userId
	 */
     @WhereSQL(sql="userId=:TcjnRecord_userId")
	 ...
	 * 公司编号
	 */
     @WhereSQL(sql="company=:TcjnRecord_company")
	 ...
	 * 统筹缴纳地
	 */
     @WhereSQL(sql="tcjnd=:TcjnRecord_tcjnd")
	 ...
	 * 部门
	 */
     @WhereSQL(sql="department=:TcjnRecord_department")
	 ...
	 * 停保月份
	 */
     @WhereSQL(sql="stopProtectMonth=:TcjnRecord_stopProtectMonth")
	 ...
	 * 保险公积金账号
	 */
     @WhereSQL(sql="insuranceorgongjijinAccount=:TcjnRecord_insuranceorgongjijinAccount")
	 ...
	 * 类型 1 保险账号 0 公积金账号
	 */
     @WhereSQL(sql="insurgongjijinType=:TcjnRecord_insurgongjijinType")
	 ...
	 * 基数
	 */
     @WhereSQL(sql="radices=:TcjnRecord_radices")
	 ...
	 * 公司缴纳部分
	 */
     @WhereSQL(sql="insuranceCompany=:TcjnRecord_insuranceCompany")
	 ...
	 * 个人缴纳部分
	 */
     @WhereSQL(sql="insurancePersonal=:TcjnRecord_insurancePersonal")
	 ...
	 * 统筹类型 
	 */
     @WhereSQL(sql="insuranceType=:TcjnRecord_insuranceType")
	 ...
	 * remark
	 */
     @WhereSQL(sql="remark=:TcjnRecord_remark")
	 ...
	 * 创建人
	 */
     @WhereSQL(sql="creator=:TcjnRecord_creator")
	 ...
	 * 创建时间
	 */
     @WhereSQL(sql="createTime=:TcjnRecord_createTime")
	 ...
	 * 用户名
	 */
     @WhereSQL(sql="userName=:TcjnRecord_userName")
	 ...
	 * 所属月份
	 */
     @WhereSQL(sql="month=:TcjnRecord_month")
	...
	public boolean equals(Object obj) {
		if(obj instanceof TcjnRecord == false){
			return false;
		}
		...
		TcjnRecord other = (TcjnRecord)obj;
